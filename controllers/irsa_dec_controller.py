...
class ExportReportIrsaControllerCNAM(http.Controller):
    ...
    def writePayslip(self, workbook, worksheet, row, col, payslip, total):
        ...
        worksheet.write(row, col + 4, '{:,}' .format(basic2), border_black)
        worksheet.write(row, col + 5, '{:,}' .format(prm), border_black)
        worksheet.write(row, col + 6, '{:,}' .format(hs), border_black)
        worksheet.write(row, col + 7, '{:,}' .format(payslip.employee_id.remaining_leaves), border_black)
        worksheet.write(row, col + 8, '{:,}' .format(preavis), border_black)
        worksheet.write(row, col + 9, '{:,}' .format(gross), border_black)
        worksheet.write(row, col + 10, '{:,}' .format(cnaps_emp), border_black)
        worksheet.write(row, col + 11, '{:,}' .format(omsi_emp), border_black)
        worksheet.write(row, col + 12, '{:,}' .format(ostie_emp), border_black)
        worksheet.write(row, col + 13, '{:,}' .format(osief_emp), border_black)
        worksheet.write(row, col + 14, '{:,}' .format(divers), border_black)
        worksheet.write(row, col + 15, '{:,}' .format(net), border_black)
        worksheet.write(row, col + 16, '{:,}' .format(mimpo), border_black)
        worksheet.write(row, col + 17, '{:,}' .format(irsa), border_black)
        worksheet.write(row, col + 18, '{:,}' .format(enfant), border_black)
        worksheet.write(row, col + 19, '{:,}' .format(impnet), border_black)
    ...
    def body(self, workbook, worksheet, payslips, total, total_net_cumul):
        ...
        worksheet.write(row + 1, col, '{:,}' .format(total['basic2']), border_black)
        worksheet.write(row + 1, col + 1, '{:,}' .format(total['prm']), border_black)
        worksheet.write(row + 1, col + 2, '{:,}' .format(total['hs']), border_black)
        worksheet.write(row + 1, col + 3, '{:,}' .format(total['conge']), border_black)
        worksheet.write(row + 1, col + 4, '{:,}' .format(total['preavis']), border_black)
        worksheet.write(row + 1, col + 5, '{:,}' .format(total['gross']), border_black)
        worksheet.write(row + 1, col + 6, '{:,}' .format(total['cnaps_emp']), border_black)
        worksheet.write(row + 1, col + 7, '{:,}' .format(total['omsi_emp']), border_black)
        worksheet.write(row + 1, col + 8, '{:,}' .format(total['ostie_emp']), border_black)
        worksheet.write(row + 1, col + 9, '{:,}' .format(total['osief_emp']), border_black)
        worksheet.write(row + 1, col + 10, '{:,}' .format(total['divers']), border_black)
        worksheet.write(row + 1, col + 11, '{:,}' .format(total['net']), border_black)
        worksheet.write(row + 1, col + 12, '{:,}' .format(total['mimpo']), border_black)
        worksheet.write(row + 1, col + 13, '{:,}' .format(total['irsa']), border_black)
        worksheet.write(row + 1, col + 14, '{:,}' .format(total['enfant']), border_black)
        worksheet.write(row + 1, col + 15, '{:,}' .format(total['impnet']), border_black)
